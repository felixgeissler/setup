...
# defaults write NSGlobalDomain NSToolbarTitleViewRolloverDelay -float 1
...
# DONT Display full POSIX path as Finder window title
...
# Modify animate opening applications from the Dock
...
# Mod the animation when hiding/showing the Dock
#defaults write com.apple.dock autohide-time-modifier -float 0.3

# DONT Automatically hide and show the Dock
